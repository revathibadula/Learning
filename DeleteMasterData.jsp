...
<BODY class=SC>
<BR><BR><BR>
<P align=center><B>Delete Employee details</B></P>
<%
...
<FORM Name='DelForm' METHOD=POST ACTION="">
		...
		<TR>
		<TH class='row_title' colspan=2>Delete Employee</TH>
		</TR>
                <TR>
...
<%
	try{
			...
			if(Condition.trim().equalsIgnoreCase("undefined")){
				...
				Query1 = "Select * from masterdata";
			}
			else{
				System.out.println("in else");
				Query1 = "Select "+Condition+" from masterdata group by "+Condition;
			}
			String str="";
...
%>
		...
		<TR><TD align=center Colspan=2><Input class= 'Button' type='Submit' name='submit' value='Delete'></TD></TR>
		</TABLE>
</FORM>
...
<%
	...
	try{
			...
			String Query = "Delete from masterdata where EmailId='"+Value+"'";
